...
return(
  <div className="flex flex-col lg:flex-row  max-w-[100vw] overflow-hidden h-[100vh]">
      <div className="w-full lg:w-[65%] bg-[#F9F9FA] flex flex-col h-[38%] lg:h-full overflow-hidden">
        <div className="flex pt-[24px]  lg:pt-8 pl-[24px]  lg:pl-8 pb-[20px] lg:pb-[24px] gap-[8px]"> 
          ...
          <div className="flex-1 flex justify-center  mb-4 lg:mb-[229px] max-h-[160px] lg:max-h-fit">
      ...
      <div className="lg:w-[35%] md:w-full  h-[62%] lg:h-full relative overflow-visible lg:overflow-hidden">
