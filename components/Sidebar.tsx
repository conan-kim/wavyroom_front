...
const Sidebar = ({ open, setOpen, menuType, setMenuType }: any) => {
  ...
  const renderMenus = () => {
    return (
      <section
        className={cn(
          "w-full lg:w-[240px] flex lg:flex gap-8 flex-col py-8 lg:border-r lg:border-r-black",
  ...
  const renderModels = () => {
    return (
      <section
        className={cn(
          "flex lg:flex gap-12 flex-col transition-width duration-300",
